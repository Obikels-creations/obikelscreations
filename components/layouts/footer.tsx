...
export function FooterComponent() {
  ...
  return (
    <footer className="bg-primary/70 text-cream-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-serif text-lg font-semibold mb-4">Stay in Touch</h3>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-4 right-4 bg-primary-foreground text-cream-100 p-2 rounded-full shadow-lg hover:bg-primary transition-colors duration-200"
          aria-label="Scroll to top"
        >
          <ArrowUp size={24} className='hover:text-white'/>
        </button>
      )}
    </footer>
  )
