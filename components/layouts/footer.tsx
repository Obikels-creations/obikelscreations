      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <Link href="https://www.facebook.com/obikelscreations" target="_blank" rel="noopener noreferrer" className="text-background hover:text-primary">
              <Facebook className="w-6 h-6" />
            </Link>
            <Link href="https://www.tiktok.com/obikels_creations" target="_blank" rel="noopener noreferrer" className="text-background hover:text-primary">
            ...
            <Link href="https://www.pinterest.com/obikels_creations" target="_blank" rel="noopener noreferrer" className="text-background  hover:text-primary">
            ...
            <Link href="https://www.youtube.com/obikels_creations" target="_blank" rel="noopener noreferrer" className="text-background hover:text-primary">
